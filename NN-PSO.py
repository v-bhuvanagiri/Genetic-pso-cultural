...
def function():
    df = pd.read_csv(r"C:\Users\Vaishnavi\Downloads\Bank_Personal_Loan_Modelling.csv")
...
class NN(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.linear1 = torch.nn.Linear(12, 8 , bias = False)
        self.linear2 = torch.nn.Linear(8, 14 , bias = False)
